...
function evg_dashboard_tab() {
    ...
    <style>
        ...
        .evg-dash-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 28px; }
        ...
        .evg-stat-box { background: #0f0f0f; border: 1px solid #222222; border-radius: 12px; padding: 20px; display: flex; align-items: center; gap: 16px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.4); transition: transform 0.2s ease, border-color 0.2s ease; }
        ...
        .evg-stat-content p { font-size: 11px; color: #8e8e93; margin: 0; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600; }
    ...
    <div class="evg-dash-container">
        <div class="evg-dash-header">
            <div>
                <h1><?php esc_html_e( 'Operational Overview,', 'evg-platform' ); ?> <span class="evg-gold-text"><?php echo esc_html( $first_name ); ?></span></h1>
        ...
        <div class="evg-dash-grid">
            <div class="evg-stat-box">
                ...
                <div class="evg-stat-content">
                    ...
                    <p><?php esc_html_e( 'Active Orders', 'evg-platform' ); ?></p>
                </div>
            </div>
            ...
            <div class="evg-stat-box">
                ...
                <div class="evg-stat-content">
                    ...
                    <p><?php esc_html_e( 'Grading Queue', 'evg-platform' ); ?></p>
                </div>
            </div>
            ...
            <div class="evg-stat-box">
                ...
                <div class="evg-stat-content">
                    ...
                    <p><?php esc_html_e( 'QC Verification', 'evg-platform' ); ?></p>
                </div>
            </div>
            ...
            <div class="evg-stat-box">
                ...
                <div class="evg-stat-content">
                    ...
                    <p><?php esc_html_e( 'Market Listings', 'evg-platform' ); ?></p>
                </div>
            </div>
            ...
            <div class="evg-stat-box">
                ...
                <div class="evg-stat-content">
                    ...
                    <p><?php esc_html_e( 'Unread Reviews', 'evg-platform' ); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="evg-split-layout">
            <div class="evg-card-panel">
                <div class="evg-card-panel-header">
                    <h2><?php esc_html_e( 'Latest Customer Submissions', 'evg-platform' ); ?></h2>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_submissions' ) ); ?>" class="evg-link-action">
                        <?php esc_html_e( 'View All Orders →', 'evg-platform' ); ?>
                    </a>
                </div>
                    ...
                    <table class="evg-dash-table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: right;"><?php esc_html_e( 'Billed', 'evg-platform' ); ?></th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="evg-card-panel">
                <div class="evg-card-panel-header">
                    <h2><?php esc_html_e( 'Action Terminal', 'evg-platform' ); ?></h2>
                </div>
                <div class="evg-actions-panel">
                    <?php if ( current_user_can( 'manage_options' ) || current_user_can( 'head_grader' ) || current_user_can( 'grader' ) ) : ?>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_grading-desk' ) ); ?>" class="evg-quick-btn">
                            <div class="evg-btn-left">
                                ...
                                <span><?php esc_html_e( 'Grading Assessment Desk', 'evg-platform' ); ?></span>
                            </div>
                    ...
                    <?php if ( current_user_can( 'manage_options' ) || current_user_can( 'head_grader' ) ) : ?>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_quality-control' ) ); ?>" class="evg-quick-btn">
                            <div class="evg-btn-left">
                                ...
                                <span><?php esc_html_e( 'Quality Control Queue', 'evg-platform' ); ?></span>
                            </div>
                            <span style="color: #8e8e93;">→</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if ( current_user_can( 'manage_options' ) || current_user_can( 'support_team' ) ) : ?>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_submissions' ) ); ?>" class="evg-quick-btn">
                            <div class="evg-btn-left">
                                <span style="font-size: 16px;">📦</span>
                                <span><?php esc_html_e( 'Check-in Submissions', 'evg-platform' ); ?></span>
                            </div>
                            <span style="color: #8e8e93;">→</span>
                        </a>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_marketplace&action=add' ) ); ?>" class="evg-quick-btn">
                            <div class="evg-btn-left">
                                <span style="font-size: 16px;">🏷️</span>
                                <span><?php esc_html_e( 'New Marketplace Slabs', 'evg-platform' ); ?></span>
                            </div>
                            <span style="color: #8e8e93;">→</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if ( current_user_can( 'manage_options' ) ) : ?>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=evg_tab_settings' ) ); ?>" class="evg-quick-btn">
                            <div class="evg-btn-left">
                                <span style="font-size: 16px;">⚙️</span>
                                <span><?php esc_html_e( 'Platform Settings & Toggles', 'evg-platform' ); ?></span>
                            </div>
                            <span style="color: #8e8e93;">→</span>
                        </a>
                    <?php endif; ?>
