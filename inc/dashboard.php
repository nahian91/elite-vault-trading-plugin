...
function evg_dashboard_tab() {
    if ( ! Elite_Vault_Grading_System::has_access( array( 'administrator', 'head_grader', 'grader', 'support_team' ) ) ) {
    ...
    <div class="evg-dash-container">
        ...
        <div class="evg-dash-grid">
            <?php if ( Elite_Vault_Grading_System::has_access( array( 'administrator', 'support_team', 'head_grader' ) ) ) : ?>
            ...
            <?php if ( Elite_Vault_Grading_System::has_access( array( 'administrator', 'head_grader', 'grader' ) ) ) : ?>
            ...
            <?php if ( Elite_Vault_Grading_System::has_access( array( 'administrator', 'head_grader' ) ) ) : ?>
            ...
            <?php if ( Elite_Vault_Grading_System::has_access( array( 'administrator', 'support_team' ) ) ) : ?>
        ...
        <div class="evg-split-layout">
                                ...
                                <?php foreach ( $recent_submissions as $sub ) : ?>
                                    <tr>
                                        ...
                                        <td style="text-align: right; font-weight: 700; color: #ffffff;">
                                            &pound;<?php echo esc_html( number_format( (float) $sub->total_amount, 2 ) ); ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
            ...
            <div class="evg-card-panel">
                ...
                <div class="evg-actions-panel">
                    ...
                    <?php if ( Elite_Vault_Grading_System::has_access( array( 'administrator' ) ) ) : ?>
